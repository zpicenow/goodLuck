...
#  define NEURONDATAREADER_DEPRECATED __declspec(deprecated)
#endif
...
#define DR_BUILDNUMB      470
#define DR_DESC           "DataReader b18"
...
extern "C" {
    ...
    */
    ...
    NEURONDATAREADER_API bool GetBoneSize(SOCKET_REF sockRef, int avatarIndex, BoneDimension* dimensions);
